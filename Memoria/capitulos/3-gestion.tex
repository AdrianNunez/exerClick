...
\begin{tabu}[h]{| l | c | c | c | c | c | c |}
  ...
  \hline  
  3º equipo & \specialcell{\textbf{Evaluación}\\DA-1(1T)\\DA-1(2T)\\DA-1(3T)\\DA-1(4T)} &  &  & \specialcell{\textbf{Evaluación}\\DA-2(1T)\\DA-2(2T)\\DA-2(3T)\\DA-2(4T)} &  & \specialcell{\textbf{Evaluación}\\UO3} \\
  \hline  
  4º equipo &  &  &  &  &  &  \\
  \hline  
\end{tabu}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{seguimiento}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{seguimiento-2}
