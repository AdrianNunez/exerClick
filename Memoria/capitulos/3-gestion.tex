...
\section{Metologías Ágiles}
\label{metodologias-agiles}

Añadir que son y que ha pasado durante el proyecto (se ha acabado por hacer algo diferente, alargando plazos).\\
...
\section{Canal de comunicación e Infraestructura de almacenamiento}
...
Las herramienta principales para el desarrollo de la aplicación serán Notepad++ y Eclipse. Para la gestión de la base de datos se usará phpMyAdmin.\\

\section{Sistemas Operativos}
\label{sistemas-operativos}

Comentar los SOs que habiamos dicho al principio y al finales cuales.\\
